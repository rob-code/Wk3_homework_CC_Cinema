...
ticket3 = Ticket.new({'customer_id' =>customer3.id, 'film_id' => film1.id, 'showtime_id' => showtime3.id})
ticket3.save()

ticket4 = Ticket.new({'customer_id' =>customer4.id, 'film_id' => film2.id, 'showtime_id' => showtime3.id})
ticket4.save()
